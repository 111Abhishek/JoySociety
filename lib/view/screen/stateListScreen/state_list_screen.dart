...
class StateListScreen extends StatefulWidget {
  final int? countryId;
  const StateListScreen({Key? key, this.countryId}) : super(key: key);
        ...
        child: NotificationListener(
          ...
          child: FutureBuilder<AppListingModel?>(
            future: Provider.of<ProfileProvider>(context, listen: false)
                .getStateList(page, searchText, widget.countryId,
                    AppConstants.STATE_LIST_URI),
            builder: (_, snap) {
              if (snap.hasData) {
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      child: CustomTextField(
                        ...
                        hintText: 'Search for state / province..',
