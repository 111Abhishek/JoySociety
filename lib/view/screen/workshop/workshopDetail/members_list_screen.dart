...
class WorkshopMembersScreen extends StatefulWidget {
  const WorkshopMembersScreen({super.key, required this.workshopId});

  final int workshopId;

  @override
  State<WorkshopMembersScreen> createState() => _WorkshopMembersScreenState();
}

class _WorkshopMembersScreenState extends State<WorkshopMembersScreen> {
        ...
        child: NotificationListener(
          ...
          child: FutureBuilder<MembersListModel?>(
            future: Provider.of<WorkshopProvider>(context, listen: false)
                .getWorkshopMembersList(
                    page, widget.workshopId, AppConstants.WORKSHOP_MEMBERS),
            builder: (_, snap) {
              if (snap.hasData) {
