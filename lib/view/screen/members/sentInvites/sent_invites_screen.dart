...
class SentInvitesScreen extends StatefulWidget {
  const SentInvitesScreen({Key? key}) : super(key: key);
...
class _SentInvitesScreenState extends State<SentInvitesScreen> {
              ...
              Column(
                children: [
                  GestureDetector(
                    onTap: () {
                      showDialog(
                          context: context, builder: (BuildContext context) => showReminderDialog()
                      );
                    },
                    child: _buildListItem(
                      context,
                      title: Text(
                        getTranslated('REMINDER', context),
                  ...
                  GestureDetector(
                    onTap: () {
                      showDialog(
                          context: context, builder: (BuildContext context) => showRevokeDialog());
                    },
                    child: _buildListItem(
                      context,
                      title: Text(
  ...
  Widget showReminderDialog() {
    return AppDialog(context: context,
      ...
      body: Container(
        child: NotificationListener(
          ...
          child: FutureBuilder<SentInvitesListResponseModel?>(
            future: Provider.of<MembersProvider>(context, listen: false).getSentInvitesList(page, searchText, AppConstants.SENT_INVTES_LIST),
            builder: (_, snap) {
              if (snap.hasData) {
                  ...
                  children: [
                    Container(
                      ...
                      child: Row(children: [
                        ...
                        Text(getTranslated('SENT_INVITES', context),
