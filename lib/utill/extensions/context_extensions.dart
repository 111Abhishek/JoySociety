...
extension ContextExtensions on BuildContext {
  ...
  bool isPhone() => MediaQuery.of(this).size.width < AppConstants.tabletBreakpointGlobal;

  bool isTablet() =>
      MediaQuery.of(this).size.width < AppConstants.desktopBreakpointGlobal &&
          MediaQuery.of(this).size.width >= AppConstants.tabletBreakpointGlobal;

  bool isDesktop() => MediaQuery.of(this).size.width >= AppConstants.desktopBreakpointGlobal;
}
